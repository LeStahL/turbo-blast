...
class GLSLLexer130:
    def __init__(self, source=""):
        ...
        self.rules += [ Rule.Rule("ivec2", "IVEC2") ]
        self.rules += [ Rule.Rule("ivec3", "IVEC3") ]
        self.rules += [ Rule.Rule("ivec4", "IVEC4") ]
